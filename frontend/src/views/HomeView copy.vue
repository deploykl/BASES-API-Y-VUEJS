  ...
  <div class="page-wrapper">
    <header class="header">
      <div class="header-content">
        <img src="@/assets/img/home/bot.png" alt="Logo" class="logo">
      </div>
    </header>
        ...
        <div class="row align-items-center justify-content-center"> <!-- Centrado vertical y horizontal -->
          ...
          <div class="col-md-6 mb-4 mb-md-0 d-flex justify-content-center">
            <img src="@/assets/img/home/work.png" alt="Presentación"
              class="img-fluid rounded mx-auto d-block image-style me-5">
          </div>

          <!-- Columna del texto - centrada vertical y horizontalmente -->
          <div class="col-md-6 text-center">
            <!-- Título principal -->
            <h1 class="mb-3 text-center text-primary fw-bold">Dirección de Monitoreo y Evaluación de la Gestión en Salud
            </h1>
            <!-- Descripción -->
            <p class="mb-3 lead">
            ...
            <!-- Botón de acceso -->
            <!-- Por esta versión condicional -->
            <div class="access-buttons">
              <button v-if="isAuthenticated" @click="goToDashboard" class="btn btn-primary btn-lg">
                <i class="bi bi-box-arrow-in-right me-2"></i>Ingresar al Sistema
              </button>
              <router-link v-else to="/login" class="btn btn-primary px-4">
                <i class="bi bi-box-arrow-in-right me-2"></i>Ingresar al Sistema
              </router-link>
            </div>
          </div>
