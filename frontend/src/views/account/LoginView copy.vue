...
<style scoped>
.background-blur {
  position: fixed; /* Cambiado de absolute a fixed para mejor cobertura */
  top: -10px;
  left: -10px;
  right: -10px;
  bottom: -10px;
  ...
  z-index: -1;
  opacity: 0.7;
  background-color: #f5f7fa; /* Color de respaldo */
}
...
.login-card {
  ...
  backdrop-filter: blur(4px); /* Blur adicional para la tarjeta */
